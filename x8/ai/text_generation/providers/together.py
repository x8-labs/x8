...
class Together(Provider):
    """Together AI provider using the native Together SDK.

    Together AI provides access to many open-source models including
        ...
        **kwargs,
        ...
        Args:
            api_key:
                Together AI API key.
            base_url:
                Together AI API base url (optional).
            timeout:
                Timeout for client requests.
            max_retries:
                Maximum number of retries for failed requests.
            model:
                Together AI model to use for text generation.
            ...
            nparams:
                Native params for Together client.
        """
    ...
    def __setup__(self, context=None):
        ...
        self._client = TogetherClient(**client_kwargs)
        self._init = True
    ...
    async def __asetup__(self, context=None):
        ...
        if self.nparams:
            client_kwargs.update(self.nparams)
        self._async_client = AsyncTogether(**client_kwargs)
        self._ainit = True
    ...
    def _convert_args(
        ...
        **kwargs: Any,
        ...
        """Convert unified args to Together Chat Completions format."""
        args: dict[str, Any] = {}
    ...
    def _convert_input_to_messages(
        ...
        """Convert unified input format to Together messages format."""
    ...
    def _convert_message_item(
        ...
        """Convert a message item to Together format."""
        role = item.get("role")
    ...
    def _convert_image_content(
        ...
        """Convert image content to Together format."""
    ...
    def _convert_tool_choice(
        ...
        """Convert tool choice to Together format."""
    ...
    def _convert_result(
        ...
        """Convert Together response to TextGenerationResult."""
    ...
    def _convert_stream_chunk(
        ...
        # Handle tool calls - use model_dump() since tool_calls may not be
        # a direct attribute in Together SDK's DeltaContent
